    ...
    override func spec() {
        ...
        context("with no operations in a request") {
            ...
            it("passes validation") {
                try! document.validateForSchema(GraphQLSchema(), ruleInitializers: [
        ...
        context("with multiple same named operations of the same type in a request") {
            ...
            it("fails validation") {
                ...
                }.to(throwError(UniqueOperationNamesError.DuplicateOperationName(Name(value: "Foo", location: nil))))
            }
        }
